...
import { PrepaymentComponent } from 'app/entities/prepayment/prepayment.component';
...
describe('Component Tests', () => {
    describe('Prepayment Management Component', () => {
        let comp: PrepaymentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PrepaymentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.prepayments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
