package io.github.ghacupha.prepay.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.github.ghacupha.prepay.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.github.ghacupha.prepay.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
